...
-file("lib/dsl/one/query_lexer.xrl", 24).
...
-file("lib/dsl/one/query_lexer.erl", 310).
yystate() -> 33.
...
yystate(35, [10|Ics], Line, Tlen, _, _) ->
    yystate(35, Ics, Line+1, Tlen+1, 3, Tlen);
...
yystate(18, [13|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
...
yystate(12, [114|Ics], Line, Tlen, Action, Alen) ->
