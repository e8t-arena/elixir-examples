...
-file("src/two_lexer.erl", 313).
yystate() -> 16.

yystate(19, [35|Ics], Line, Tlen, Action, Alen) ->
...
yystate(10, [10|Ics], Line, Tlen, _, _) ->
    yystate(14, Ics, Line+1, Tlen+1, 2, Tlen);
...
yystate(5, Ics, Line, Tlen, _, _) ->
    {6,Tlen,Ics,Line,5};
yystate(4, [35|Ics], Line, Tlen, Action, Alen) ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/two_lexer.xrl", 31).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/0}).
-file("src/two_lexer.xrl", 32).
yyaction_1() ->
     skip_token .

-compile({inline,yyaction_2/0}).
-file("src/two_lexer.xrl", 33).
yyaction_2() ->
     skip_token .

-compile({inline,yyaction_3/2}).
-file("src/two_lexer.xrl", 34).
yyaction_3(TokenChars, TokenLine) ->
     { token, { eq, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/two_lexer.xrl", 35).
yyaction_4(TokenChars, TokenLine) ->
     { token, { mtp_name, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/2}).
-file("src/two_lexer.xrl", 36).
yyaction_5(TokenChars, TokenLine) ->
     { token, { mtp_name, TokenLine, split_msg_type (TokenChars) } } .

-compile({inline,yyaction_6/2}).
-file("src/two_lexer.xrl", 38).
yyaction_6(TokenChars, TokenLine) ->
     { token, { primitive_type, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("src/two_lexer.xrl", 39).
yyaction_7(TokenChars, TokenLine) ->
