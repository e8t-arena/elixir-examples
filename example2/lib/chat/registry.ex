defmodule AppExample.Chat.Registry do
  use GenServer

  def start_link do
    GenServer.start_link(__MODULE__, nil, name: :chat_registry)
  end
  ...
  def register_name(room_name, pid) do
    GenServer.call(:chat_registry, {:register_name, room_name, pid})
  end

  def unregister_name(room_name) do
    GenServer.cast(:chat_registry, {:unregister_name, room_name})
  end
